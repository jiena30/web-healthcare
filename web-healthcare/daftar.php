    ...
    <div class="register-container">
      ...
      <form action="#" method="POST" autocomplete="off">
        <div class="row g-4">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="floatingNama" placeholder="Nama Lengkap" required>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="number" class="form-control" id="floatingNIK" placeholder="NIK" required>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="floatingTempat" placeholder="Tempat Lahir" required>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="date" class="form-control" id="floatingTanggal" required>
            ...
            <div class="field-group-container">
              ...
              <div class="gender-box-row">
                <div class="form-check d-flex align-items-center m-0">
                  <input class="form-check-input" type="radio" name="jenisKelamin" id="radioLaki" value="Laki-laki" checked required>
                  <label class="form-check-label" for="radioLaki">Laki-laki</label>
                </div>
                <div class="form-check d-flex align-items-center m-0">
                  <input class="form-check-input" type="radio" name="jenisKelamin" id="radioPerempuan" value="Perempuan">
          ...
          <div class="col-md-6">
            <div class="field-group-container">
              ...
              <div class="form-floating">
                <select class="form-select" id="floatingMetode" required>
                  <option value="" disabled selected>Pilih Jaminan Kesehatan</option>
                  <option value="bpjs">BPJS Kesehatan</option>
                  <option value="asuransi">Asuransi Swasta</option>
                  <option value="umum">Mandiri / Umum (Bayar Sendiri)</option>
                </select>
          ...
          <div class="col-md-12">
            <label class="upload-box" for="fileBpjs">
              ...
              <input type="file" id="fileBpjs" accept="image/*,.pdf" style="display: none;" onchange="updateFileName(this)">
            </label>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-floating">
              <textarea class="form-control" placeholder="Alamat Rumah" id="floatingAlamat" required></textarea>
        ...
        <button type="submit" class="btn-register">
          <i class="bi bi-check-circle-fill me-2"></i> Selesaikan Pendaftaran
        </button>

        <div class="login-link">
          Sudah terdaftar? <a href="#">Masuk akun</a>
        </div>
      </form>
